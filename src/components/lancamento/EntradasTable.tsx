  ...
  return (
    <div>
      ...
      <div className="hidden md:block bg-card border border-border border-t-0 rounded-b-lg overflow-hidden">
        <div className="grid grid-cols-[2fr_1.4fr_1fr_1fr_32px] bg-thead border-b border-border px-3 py-1.5">
        ...
        {rows.map(row => (
          <div
            key={row.id}
            className="grid grid-cols-[2fr_1.4fr_1fr_1fr_32px] px-3 py-2 items-center gap-2 border-b border-border last:border-0 odd:bg-card even:bg-roweven hover:bg-rowhover"
          >
            <input
              key={"d" + row.desc}
              type="text"
